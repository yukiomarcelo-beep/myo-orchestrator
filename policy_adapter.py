...
THRESHOLD_MIN = 40 # drift floor: nunca abaixo disso (escala segura)
THRESHOLD_MAX = 90 # drift ceiling: nunca acima disso (sistema não trava)
...
def apply_adjustments(
 ...
 """
 Aplica ajustes na policy em memória.
 Retorna lista de changes realizadas.
 """
 changes: list[str] = []
...
def main():
 ...
 parser.add_argument("--rollback", metavar="SNAPSHOT", help="Restaura policy de um snapshot (ex: context_policy_2026-03-26_143000.json)")
 ...
 policy, topic_failures, exp_success, dry_run=args.dry_run
 )
